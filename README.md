...
Destructors are called when there is no more reference to the object. It is also called when the script execution is ended using exit
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjQ4NzM0NTc0LC0xMDI5Nzg2NDE0LC04NT
